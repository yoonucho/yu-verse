...
import { normalizeEventForStore } from "@/utils/eventMapping";
...
const MainCalendar: React.FC = () => {
  ...
  const eventClick = (info: EventClickArg) => {
    ...
    setIsEditing(false);
    setSelectedEvent(normalizeEventForStore(info.event));
  ...
  return (
    <>
      <CalendarComponent
        ...
        handleDateClick={handleInteraction}
      />
      <EventPopupControl />
    </>
  );
